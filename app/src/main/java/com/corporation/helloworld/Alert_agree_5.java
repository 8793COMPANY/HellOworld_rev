...
public class Alert_agree_5 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_alert_agree_5);
        ...
        Alert_agree_no.setOnClickListener(v -> {
            Toast.makeText(Alert_agree_5.this, "약관에 동의해주세요", Toast.LENGTH_SHORT).show();
