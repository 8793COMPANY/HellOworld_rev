...
public class Alert_agree_3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_alert_agree_3);
        ...
        Alert_agree_no.setOnClickListener(v -> {
            Toast.makeText(Alert_agree_3.this, "약관에 동의해주세요", Toast.LENGTH_SHORT).show();
