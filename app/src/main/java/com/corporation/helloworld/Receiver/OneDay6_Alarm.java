...
public class OneDay6_Alarm extends BroadcastReceiver {
...
//        Log.e("time",time);
        ...
        if (!cursor.getString(1).equals("배터리 5% 이하입니다.")) {
          ...
          //  CheckService.mStepDetector = 0;
            ...
            application.sendtoMessage("P1/"+application.encryption(application.current_Date() + "/" + sendData));
//            application.setAlarm_6();
