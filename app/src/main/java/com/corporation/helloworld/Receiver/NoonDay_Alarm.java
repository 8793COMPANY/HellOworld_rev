...
public class NoonDay_Alarm extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Log.e("알람 두번째 코드 실행","알람 두번째 코드 실행");
        ...
        if (!cursor.getString(1).equals("배터리 5% 이하입니다.")) {
            ...
            application.sendtoMessage("A1/"+application.encryption(application.current_Date() + "/" + sendData));
